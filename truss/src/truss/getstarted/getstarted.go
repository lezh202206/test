...
// removeDotProtoSuffix exists to preempt and warn a merchant who enters a name
// containing `.proto`. It will warn the merchant of their incorrect input and will
